...
ImposterView::ImposterView() :
  _imposter(0), _texNode(0), _TYPENAME("IMPOSTERVIEW"), _texEnt(0),
      _curFlipTheta(0), _curFlipPhi(0), _MATERIALNAME("ZGame/Imposter")
{
