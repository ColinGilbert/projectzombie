...
_valRange(7.0f)
{
    ...
    */
    ...
    constantnegaOne.setValue(-1.0);
    constantone.setValue(0.75);
    final.setSourceModule(0, constantnegaOne);
    final.setSourceModule(1, constantone);
    final.setControlModule(finalTerrain);
    final.setLowerBound(0.0);
    final.setUpperBound(1);
    final.setEdgeFalloff(0);
